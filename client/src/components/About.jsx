...
// function About() {
//   return (
//     <section className="relative py-28 bg-linear-to-b from-black to-[#12061c] overflow-hidden text-white">
//       {/* GLOW EFFECTS */}
//       <div className="absolute top-10 left-10 w-72 h-72 bg-[#B57EDC]/20 blur-[120px] rounded-full"></div>
...
//           {/* Glow Border */}
//           <div className="absolute -inset-1 bg-linear-to-r from-[#B57EDC] to-purple-300 rounded-[35px] blur opacity-60 group-hover:opacity-100 transition duration-500"></div>
...
//               alt="DMIO"
//               className="w-full h-137.5 object-cover transition duration-700 group-hover:scale-110 fade-in"
//             />
...
//             {/* Floating Badge */}
//             <div className="absolute bottom-6 left-6 bg-white/10 backdrop-blur-2xl border border-white/10 px-6 py-4 rounded-2xl animate-bounce">
//               <p className="text-[#B57EDC] font-bold text-lg">
//                 2K+ Students Trained
//               </p>
//             </div>
//           </div>
...
//         {/* RIGHT CONTENT */}
//         <div>
//           <p className="uppercase tracking-[8px] text-[#B57EDC] mb-5 text-2xl">
//             About DMIO
//           </p>

//           <h2 className="text-4xl md:text-3xl font-black leading-tight mb-8">
//             Empowering The Next Generation Of
//             <span className="block text-[#B57EDC]">
//               Digital Marketers
//             </span>
//           </h2>
...
//             students master SEO, branding, social media, AI marketing, content
//             creation, and paid advertising through hands-on training.
//           </p>

//           {/* CARDS */}
//           <div className="grid sm:grid-cols-2 gap-6">
//             {/* CARD 1 */}
//             <div className="group bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-7 hover:bg-[#B57EDC]/15 hover:border-[#B57EDC]/40 transition-all duration-500 hover:-translate-y-2">
//               <div className="w-14 h-14 rounded-2xl bg-[#B57EDC]/20 flex items-center justify-center mb-5 group-hover:bg-[#B57EDC]/30 transition">
//                 <Megaphone className="text-[#B57EDC]" size={28} />
//               </div>
...
//                 agencies with hands-on practical projects.
//               </p>
//             </div>
...
//             <div className="group bg-white/5 border border-white/10 backdrop-blur-xl rounded-3xl p-7 hover:bg-[#B57EDC]/15 hover:border-[#B57EDC]/40 transition-all duration-500 hover:-translate-y-2">
//               <div className="w-14 h-14 rounded-2xl bg-[#B57EDC]/20 flex items-center justify-center mb-5 group-hover:bg-[#B57EDC]/30 transition">
//                 <GraduationCap className="text-[#B57EDC]" size={28} />
//               </div>
...
//               <p className="text-gray-300 leading-relaxed">
//                 Get mentorship, portfolio guidance, internship preparation, and
//                 career support to become job-ready.
//               </p>
//             </div>
//           </div>
//         </div>
